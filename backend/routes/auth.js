  ...
  db.query(query, [user, password], (err, results) => {
    ...
    if (results.length > 0) {
      ...
      res.json({
        ...
        nombre: userData.nombre, // Devuelve el nombre
        apellidoPaterno: userData.apellidoPaterno, // Devuelve el apellido
        firma: userData.firma, // Devuelve la firma del usuario
      });
    } else {
